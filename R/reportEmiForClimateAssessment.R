...
reportEmiForClimateAssessment <- function(gdx, output = NULL, regionSubsetList = NULL,
  ...
  vm_emiTeDetailMkt <- gdx2::readGDX(gdx, c("vm_emiTeDetailMkt", "v_emiTeDetailMkt"),
                                     uniqueStyle = "classic", select = list("_field" = "level"),
                                     restoreZeros = FALSE, format = "first_found")[, t, ]
  ...
  # F-Gases
  vm_emiFgas <- gdx2::readGDX(gdx, "vm_emiFgas", select = list("_field" = "level"), restoreZeros = FALSE)[, t, ]
