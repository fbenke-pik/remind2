...
reportAirPollutantEmissions <- function(gdx, output = NULL, regionSubsetList = NULL,
  ...
  ap_scenario <- gdx2::readGDX(gdx, "cm_APscen")
  cm_APssp <- gdx2::readGDX(gdx, "cm_APssp")
  cm_GDPpopScen <- gdx2::readGDX(gdx, "cm_GDPpopScen")
  ap_source <- as.numeric(gdx2::readGDX(gdx, "cm_APsource"))
  # get AP ssp
  ...
  cm_MAgPIE_Nash <- gdx2::readGDX(gdx, "cm_MAgPIE_Nash") %>% as.vector()
