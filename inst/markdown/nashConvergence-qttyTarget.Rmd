...
tgts <-
  pm_implicitQttyTarget %>%
  select("ext_regi", "ttot", "qttyTarget", "qttyTarget", "qttyTargetGroup") %>%
  mutate_at(c("ttot"), as.numeric) %>%
  mutate(group = paste0(qttyTarget, " ", qttyTargetGroup, " - ", ttot))
      ...
      p <- plot_ly(data = d, height = 350) %>% #
        ...
        layout(
          ...
          yaxis2 = list(
            ...
            zerolinewidth = 3,
            showgrid = FALSE,
            title = list(text = "Tax (US$2005/GJ)", font = list(
              color =
                qttyTaxColor["price"]
            )),
            overlaying = "y",
