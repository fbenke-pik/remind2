...
plotFlipflopStrip <- function(vars, gdx = params$gdx) {
  lastIteration <- gdx2::readGDX(gdx, "o_iterationNumber", react = "error")[[1]]
...
readScalar <- function(v) {
  x <- suppressWarnings(gdx2::readGDX(params$gdx, v, react = "silent"))
...
p45_peakBudgYr_check <- gdx2::readGDX(params$gdx, "p45_peakBudgYr_check")
